-- 1. INSERT USERS
INSERT INTO users (first_name, last_name, email, role_name, created_at)
VALUES 
    ('Elena', 'Rostova', 'elena.admin@fleetco.com', 'Admin', CURRENT_TIMESTAMP),
    ('Marcus', 'Vance', 'marcus.manager@fleetco.com', 'Manager', CURRENT_TIMESTAMP),
    ('Sarah', 'Jenkins', 's.jenkins@fleetco.com', 'Dispatcher', CURRENT_TIMESTAMP),
    ('David', 'Chen', 'david.chen88@gmail.com', 'Customer', CURRENT_TIMESTAMP);
